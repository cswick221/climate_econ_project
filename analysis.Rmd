...
counties_out_df$in_out <- rep(c("0"), times = 234) #adding a column that these counties are out 
...
counties_in_df$in_out <- rep(c("1"), times = 1296) #adding a column that these counties are in
```
